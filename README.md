...
1. Asks which clients to set up — `space` to toggle **Claude Desktop** /
   **Claude Code CLI** (or `GA_MCP_TARGETS=desktop,cli`).
2. Asks whether to add **Google Ads** and **Google Tag Manager** (or
   `GA_MCP_WITH_ADS=1`, `GA_MCP_WITH_GTM=1`).
